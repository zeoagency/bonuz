											...
											<div class="row">
												...
												<div class="col-sm-2">
													<div class="form-group label-floating is-empty">
														<input type="text" name="monthly_limit" class="form-control" value="{{ options.monthly_limit }}">
												...
												<div class="col-sm-2">
													<div class="form-group label-floating is-empty">
														<input type="text" name="welcome_bonus" class="form-control" value="{{ options.welcome_bonus }}">
														<span class="material-input"></span>
													</div>
												</div>
												...
												<div class="col-sm-2">
													<div class="form-group label-floating is-empty">
														<input type="text" name="birthday_bonus" class="form-control" value="{{ options.birthday_bonus }}">
														<span class="material-input"></span>
													</div>
												</div>
												<label class="col-sm-2 label-on-left">birthday bonus text</label>
												<div class="col-sm-2">
													<div class="form-group label-floating is-empty">
														<input type="text" name="birthday_bonus_text" class="form-control" value="{{options.birthday_bonus_text ? options.birthday_bonus_text : "Happy birthday <mentionName> <amount> !" }}">
														<span class="material-input"></span>
													</div>
												</div>
									...
									<div class="card">
										...
										<div class="card-content">
											...
											<div class="material-datatables">
												<table id="friends-dt" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
													<thead>
														<tr>
															<th>#id</th>
															<th>email</th>
													...
													<tbody>
														...
														{% for user in users %}
															<tr>
																...
																<td class="text-right">
																	{% if user['status'] == 0 %}
																		<a href="#" class="btn btn-simple btn-info btn-icon status">
																			<i class="material-icons" title="open account">tag_faces</i>
																		</a>
																	{% else %}
																		<a href="#" class="btn btn-simple btn-info btn-icon status">
																			<i class="material-icons" title="suspend account">block</i>
																		</a>
																	{% endif %}

																	{% if user['is_admin'] == 0 %}
																		<a href="#" class="btn btn-simple btn-info btn-icon is_admin">
																			<i class="material-icons" title="make admin">flight_takeoff</i>
																		</a>
																	{% else %}
																		<a href="#" class="btn btn-simple btn-info btn-icon is_admin">
																			<i class="material-icons" title="make user">flight_land</i>
																		</a>
																	{% endif %}
																	<a href="#" class="btn btn-simple btn-info btn-icon discord_id">
																		<i class="material-icons" title="set discord id">mood</i>
																	</a>

																	<a href="#" class="btn btn-simple btn-danger btn-icon newpassword">
																		<i class="material-icons" title="send new password">lock</i>
																	</a>
																</td>
															</tr>
								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-content">
											...
											<div class="material-datatables">
												<table id="hashtags-dt" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
													<thead>
														<tr>
															<th>#id</th>
															<th>hashtag</th>
													...
													<tbody>
														{% for hashtag in hashtags %}
															<tr>
																...
																<td>
																	{% if hashtag.active == 0 %}
																		<a href="#" class="btn btn-simple btn-info btn-icon active">
																			<i class="material-icons" title="enable hashtag">done</i>
																		</a>
																	{% else %}
																		<a href="#" class="btn btn-simple btn-info btn-icon active">
																			<i class="material-icons" title="disable hashtab">block</i>
																		</a>
																	{% endif %}
																</td>
															</tr>
							...
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-content">
										...
										<div class="row">
											<div class="nav-center">
												<ul class="nav nav-center nav-pills nav-pills-warning nav-pills-icons" role="tablist">
													<li class="active">
											...
											<div class="tab-content">
												<div class="tab-pane active" id="listDemands">
													...
													<div class="material-datatables">
														<table id="demands-dt" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
															<thead>
																<tr>
																	<th>#id</th>
																	<th>date</th>
															...
															<tbody>
																{% for s in spents %}
																	<tr>
																		...
																		<td class="text-right">
																			{% if s.status == 0 %}
																				<a href="#" class="btn btn-simple btn-info btn-icon approveReward">
																					<i class="material-icons" title="approve">done</i>
																				</a>

																				<a href="#" class="btn btn-simple btn-info btn-icon rejectReward">
																					<i class="material-icons" title="reject">clear</i>
																				</a>
												...
												<div class="tab-pane" id="listRewards">
													...
													<div class="tab-content">
														<div class="tab-pane active" id="listallrewardsPanel">
															...
															<div class="material-datatables">
																<table id="rewards-dt" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
																	<thead>
																		<tr>
																			<th>#id</th>
																			<th>name</th>
																		...
																		{% for reward in rewards %}
																			<tr>
																				...
																				<td class="text-right">
																					...
																					<a href="#" class="btn btn-simple btn-info btn-icon updatePrice" title="update price">
																					...
																					{% if reward.status == 0 %}
																						<a href="#" class="btn btn-simple btn-info btn-icon status">
																							<i class="material-icons" title="enable reward">done</i>
																						</a>
																					{% else %}
																						<a href="#" class="btn btn-simple btn-info btn-icon status">
																							<i class="material-icons" title="disable reward">block</i>
																						</a>
																					{% endif %}
															...
															<div class="row">
																<div class="col-md-8 col-md-offset-2">
																	<form id="addnewrewardForm" method="POST" action="#">
																		...
																		<button id="addNewRewardButton" type="submit" class="btn btn-fill btn-success">add
																		</button>
																	</form>
																</div>
															</div>
...
$.post("area/addnewfriend", {email: email}).done(function (res) {
if (res == 200) {
swal({
type: 'success',
title: 'friend added!',
html: 'mail was sent to ' + email
});
} else {
...
$.post("area/updatestatus", {
userId: data[0].replace('#', '')
}).done(function (res) {
if (res == 0) {
...
swal({
type: 'success',
title: 'password renewed!',
html: 'new passwrod was sent to ' + data[1]
});
$.post("area/renewpassword", {
userId: data[0].replace('#', '')
}).done(function (res) {
swal({
type: 'success',
title: 'password updated',
html: 'new password is ' + res
});
});
...
$.post("area/updatehashtag", {
hashtagId: data[0].replace('#', '')
}).done(function (res) {
if (res == 0) {
...
$.post("area/addhashtag", {hashtag: hashtag}).done(function (res) {
if (res == 200) {
var last_row = hashtagDT.row(':last').data();
hashtagDT.row.add([
parseInt(last_row[0]) + 1,
hashtag
]).draw();
...
$.post("area/updaterewardprice", {
rewardId: data[0].replace('#', ''),
price: price
}).done(function (res) {
console.log(res);
...
$.ajax({
type: 'POST',
url: "area/addnewreward",
data: $('#addnewrewardForm').serialize(),
success: function (cevap) {
